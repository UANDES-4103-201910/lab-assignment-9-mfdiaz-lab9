...
user_1 = User.create(name: 'Francisco', last_name: 'Borie', email: 'fjborie@miuandes.cl', phone: '987654321', password: 'password123', address: 'San Carlos de Apoquindo 2200', role: 'admin')
user_2 = User.create(name: 'Diego', last_name: 'Beckdorf', email: 'dbeckdorf@miuandes.cl', phone: '987654321', password: 'password123', address: 'San Carlos de Apoquindo 2200', role: 'regular')
user_3 = User.create(name: 'Maximiliano', last_name: 'Garcia', email: 'mrgarcia1@miuandes.cl', phone: '987654321', password: 'password123', address: 'San Carlos de Apoquindo 2200', role: 'regular')
